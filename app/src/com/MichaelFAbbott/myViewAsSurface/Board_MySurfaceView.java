...
public class Board_MySurfaceView extends SurfaceView implements SurfaceHolder.Callback {

		//Thread t = null;
	
		Board_MyThread t = null;
	
		SurfaceHolder holder;
		boolean isItOK = false;
		
		public Board_MySurfaceView(Context context) {
			super(context);
			// TODO Auto-generated constructor stub
			holder = getHolder();
			
			t = new Board_MyThread(this);
		}
